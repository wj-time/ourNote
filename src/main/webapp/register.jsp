...
<section class="reg_box">
	<form class="login-form" action="user/add" method="post">
       ...
       <div class="form_body">
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="nickname" class="span3" placeholder="请输入昵称" nullmsg="请填写昵称" value="" name="nickname">
            </div>
          </div>
          <div class="control-group">
            <label class="control-label" for="realName">真实姓名</label>
            <div class="controls">
              <input type="text" id="realName" class="span3" placeholder="请输入真实姓名" nullmsg="请填写真实姓名" value="" name="realName">
            </div>
          </div>
          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="inputMobile" class="span3" placeholder="请输入手机号码" nullmsg="请填写手机号码" value="" name="mobile">
            </div>
          </div>     
          <div class="control-group">
            <label class="control-label" for="inputEmail">邮箱</label>
            <div class="controls">
              <input type="text" id="inputEmail" class="span3" placeholder="请输入电子邮件" nullmsg="请填写邮箱" value="" name="email">
            </div>
          </div>      
          <div class="control-group">
